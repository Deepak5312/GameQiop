 ...
 */
public class MID_Grand_Theft_Auto_1 extends javax.swing.JFrame {
    
    /**
     * Creates new form Buy_Assiss
     */
    public MID_Grand_Theft_Auto_1() {
        initComponents();                
    ...
    private void initComponents() {
        ...
        name.setText("Grand Theft Auto V");
        ...
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/GTA_PC_1.png"))); // NOI18N
        ...
        Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/GTA_PS4_1.jpg"))); // NOI18N
        ...
        Img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/GTA_Xbox 1_1.jpg"))); // NOI18N
        ...
        p1.setText("3499");
        pan1_2.add(p1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 120, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','Grand Theft Auto : V','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "','" +k+ "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_Grand_Theft_Auto_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_Grand_Theft_Auto_1().setVisible(true);
            }
        });
    }
