 ...
 */
public class TOP_Tom_Clancy_2 extends javax.swing.JFrame {
            
    String GID = "GID037";
    
    public TOP_Tom_Clancy_2() {
        initComponents();
        ...
        new Thread(new Runnable() {
           ...
           public void run() {
               ...
               while(a == 1) {
                   ...
                   {
                       try {                                                               
                                Img.setIcon(new ImageIcon("C:\\Users\\Monika\\Documents\\NetBeansProjects\\Final Project\\src\\Cover_Images\\TC_2_1.jpg"));
                                                           
                                Thread.sleep(3000);
                                Img.setIcon(new ImageIcon("C:\\Users\\Monika\\Documents\\NetBeansProjects\\Final Project\\src\\Cover_Images\\TC_2_2.jpg"));
                                                          
                                Thread.sleep(3000);
                                Img.setIcon(new ImageIcon("C:\\Users\\Monika\\Documents\\NetBeansProjects\\Final Project\\src\\Cover_Images\\TC_2_3.jpg"));
                                                          
                                Thread.sleep(3000);
                                Img.setIcon(new ImageIcon("C:\\Users\\Monika\\Documents\\NetBeansProjects\\Final Project\\src\\Cover_Images\\TC_2_4.jpg"));
                                                          
                                Thread.sleep(3000);
                                Img.setIcon(new ImageIcon("C:\\Users\\Monika\\Documents\\NetBeansProjects\\Final Project\\src\\Cover_Images\\TC_2_5.jpg"));
    ...
    private void initComponents() {
        ...
        n1.setText("Tom Clancy's The divison");
        ...
        PC.setText("<html><body><b>Pc </b><br> <font color = 'red' size = 4>Rs. 2999");
        ...
        PS.setText("<html><body><b>PlayStation 4 </b><br> <font color = 'red' size = 4>Rs. 3599");
        ...
        XB.setText("<html><body><b>Xbox One </b><br> <font color = 'red'  size = 4>Rs. 3499");
        ...
        jLabel3.setText("<html><body>Tom Clancy's The Division is an action role-playing game set in an open world mid-crisis Manhattan with destructible environments that can be freely explored by the players. The player's mission is to restore order by investigating the source of a virus.");
        ...
        P.setText("2999");
        Origins.add(P, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 210, 80, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MID_Tom_Clancy_2 f1 = new MID_Tom_Clancy_2();
        String platform = "PC";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TOP_Tom_Clancy_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TOP_Tom_Clancy_2().setVisible(true);
            }
        });
    }
