 ...
 */
public class MID_Need_for_Speed_3 extends javax.swing.JFrame {
    
    /**
     * Creates new form Buy_Assiss
     */
    public MID_Need_for_Speed_3() {
        initComponents();                
    ...
    private void initComponents() {
        ...
        name.setText("Need for Speed Rivals");
        ...
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/NFS_PC_3.jpg"))); // NOI18N
        ...
        Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/NFS_PS4_3.jpg"))); // NOI18N
        ...
        Img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/NFS_Xbox 1_3.jpeg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','Need for Speed : Rivals','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "','" +k+ "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_Need_for_Speed_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_Need_for_Speed_3().setVisible(true);
            }
        });
    }
