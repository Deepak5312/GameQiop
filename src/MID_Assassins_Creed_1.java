 ...
 */
public class MID_Assassins_Creed_1 extends javax.swing.JFrame {
    
    /**
     * Creates new form Buy_Assiss
     */
    public MID_Assassins_Creed_1() {
        initComponents();                
    ...
    private void initComponents() {
        ...
        name.setText("Assassins Creed Origins");
        ...
        pan1_1.add(l3_UN, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 10, 120, 40));
        ...
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/AC_PC_1.jpg"))); // NOI18N
        ...
        Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/AC_PS4_1.jpg"))); // NOI18N
        ...
        Img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/AC_Xbox 1_1.jpg"))); // NOI18N
        ...
        p1.setText("3499");
        pan1_2.add(p1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 110, 40));

        cb1.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        cb1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Add Credit and Debit Card", "Net Banking", "Cash on Delivery" }));
        ...
        Comp5.setText("City :");
        pan1_2.add(Comp5, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 370, 140, 30));
        ...
        pan1_2.add(Comp13, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 180, 200, 40));
        ...
        pan1_2.add(Comp6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 300, 140, 40));
        ...
        pan1_2.add(Comp11, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 240, 130, 40));

        Pr1.setFont(new java.awt.Font("Unispace", 0, 30)); // NOI18N
        Pr1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Pr1.setText("Rs.");
        pan1_2.add(Pr1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, 60, 40));
        ...
        pan1_2.add(jlable1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, 140, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','"+k+"','Assassins Creed : Origins','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "');";
            int rs = st.executeUpdate(qry);                        
            JOptionPane.showMessageDialog(null,"Item added to the Cart","Cart Updated",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_Assassins_Creed_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_Assassins_Creed_1().setVisible(true);
            }
        });
    }
