 ...
 */
public class MID_PUBG_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        name.setText("Player's Unknown Battlegrounds");
        ...
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/PUBG_PC.jpg"))); // NOI18N
        ...
        p1.setText("2599");
        pan1_2.add(p1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 90, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','Players Unknown Battlegrounds','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "','" +k+ "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_PUBG_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_PUBG_1().setVisible(true);
            }
        });
    }
