 ...
 */
public class MID_Call_of_Duty_2 extends javax.swing.JFrame {
    
    /**
     * Creates new form Buy_Assiss
     */
    public MID_Call_of_Duty_2() {
        initComponents();                
    ...
    private void initComponents() {
        ...
        name.setText("Call of Duty Infinite Warfare");
        ...
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/COD_PC_2.jpg"))); // NOI18N
        ...
        Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/COD_PS4_2.jpg"))); // NOI18N
        ...
        Img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/COD_Xbox 1_2.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','Call of Duty : Infinite Warfare','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "','" +k+ "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_Call_of_Duty_2 .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_Call_of_Duty_2 ().setVisible(true);
            }
        });
    }
