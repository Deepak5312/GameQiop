 ...
 */
public class MID_Grand_Theft_Auto_2 extends javax.swing.JFrame {
    
    /**
     * Creates new form Buy_Assiss
     */
    public MID_Grand_Theft_Auto_2() {
        initComponents();                
    ...
    private void initComponents() {
        ...
        name.setText("Grand Theft Auto IV");
        ...
        Company.setFont(new java.awt.Font("Roboto Light", 0, 24)); // NOI18N
        Company.setForeground(new java.awt.Color(0, 102, 204));
        Company.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Company.setText("ROCKSTAR");
        pan1_2.add(Company, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 130, 40));

        Img1.setFont(new java.awt.Font("Segoe Print", 0, 24)); // NOI18N
        Img1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/GTA_PC_2.jpg"))); // NOI18N
        ...
        Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/GTA_PS4_2.jpg"))); // NOI18N
        ...
        Img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/GTA_Xbox 1_2.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','Grand Theft Auto : IV','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "','" +k+ "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_Grand_Theft_Auto_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_Grand_Theft_Auto_2().setVisible(true);
            }
        });
    }
