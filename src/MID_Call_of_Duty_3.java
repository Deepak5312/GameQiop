 ...
 */
public class MID_Call_of_Duty_3 extends javax.swing.JFrame {
    
    /**
     * Creates new form Buy_Assiss
     */
    public MID_Call_of_Duty_3() {
        initComponents();                
    ...
    private void initComponents() {
        ...
        name.setText("Call of Duty Black Ops III");
        ...
        Img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/COD_PC_3.jpg"))); // NOI18N
        ...
        Img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/COD_PS4_3.jpeg"))); // NOI18N
        ...
        Img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Platform_Images/COD_Xbox 1_3.jpg"))); // NOI18N
        ...
        pan1_2.add(jlable1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, 120, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String qry = "Insert into buy values('" +h+ "','Call of Duty : Black Ops III','" +j+ "'," +(d+1)+ "," +T+ ",'" +e+ "','" +c+ "','" +b+ "%','" +f+ "','" +k+ "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MID_Call_of_Duty_3 .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MID_Call_of_Duty_3 ().setVisible(true);
            }
        });
    }
